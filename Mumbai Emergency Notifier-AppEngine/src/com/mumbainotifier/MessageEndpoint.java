 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "mumbainotifier.com", ownerName = "mumbainotifier.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBcYcmSH_yiNWu_1NLZG3KKK_ReEg0qa-A";
